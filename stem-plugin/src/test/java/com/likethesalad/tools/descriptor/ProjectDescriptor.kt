package com.likethesalad.tools.descriptor

import com.likethesalad.tools.blocks.GradleBlockItem
import com.likethesalad.tools.blocks.impl.GradleDependenciesBlockItem
import com.likethesalad.tools.blocks.impl.plugins.GradlePluginsBlockItem
import com.likethesalad.tools.content.ProjectDirBuilder
import java.io.File

abstract class ProjectDescriptor(val projectName: String, inputDir: File) {
